package com.cursomeetups.ui.recyclerview.adapter
...
class ListaEventosAdapter(
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ListaEventosAdapter.ViewHolder {
        return ViewHolder(
    ...
    override fun onBindViewHolder(holder: ListaEventosAdapter.ViewHolder, position: Int) {
